...
public class CustomRenderer extends EntityRenderer {
    ...
    private float customYaw, customPitch;

    public CustomRenderer(Minecraft mcIn, IResourceManager resourceManagerIn) {
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(customPitch - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(customYaw - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
                GlStateManager.rotate(f1 - customYaw, 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - customPitch, 1.0F, 0.0F, 0.0F);
            }
        } else {
        ...
        if (!this.mc.gameSettings.debugCamEnable) {
            ...
            GlStateManager.rotate(customPitch, 1.0F, 0.0F, 0.0F);
            GlStateManager.rotate(customYaw + 180.0F, 0.0F, 1.0F, 0.0F);
        }
    ...
    public void updateCameraAndRender(float p_181560_1_, long p_181560_2_) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            ...
            if (this.mc.gameSettings.smoothCamera) {
                ...
                customYaw += f2 / 8.0F;
                customPitch += f3 / 8.0F;
                if (Math.abs(customPitch) > 90.0F)
                    customPitch = (customPitch > 0.0F ? 90.0F : -90.0F);
                ...
                try {
                    ...
                    crashreportcategory.addCrashSectionCallable("Screen name", new Callable<String>() {
                        public String call() throws Exception {
                            return CustomRenderer.this.mc.currentScreen.getClass().getCanonicalName();
                        }
                    });
